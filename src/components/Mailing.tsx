...
const Mailing = () => {
	return (
		<div id='mailing' className='mailing px-5 py-10 tab:px-8 tab:pt-[20rem] '>
			<div className="laptop:max-w-[1200px] laptop:mx-auto">
				<div className='mb-8'>
				...
				<form className='w-full flex flex-col mb-20 tab:flex-row tab:justify-center laptop:w-[60%] laptop:mx-auto'>
					<input
						type='email'
				...
				<div className='tab:grid tab:grid-cols-2 laptop:grid-cols-3'>
